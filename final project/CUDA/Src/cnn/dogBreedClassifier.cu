...
int main(int argc, char* argv) {
	using namespace cnn;
	std::string path = "C:/Users/wangh/Desktop/Master - UCSD/Courses/ECE 285/CUDA/Final Project/datasets";
	std::ofstream out("C:/Users/wangh/Desktop/Master - UCSD/Courses/ECE 285/CUDA/Final Project/out.txt");
